...
// * 序列化参数
export const getPendingUrl = (config: AxiosRequestConfig | InternalAxiosRequestConfig) =>
...
export class AxiosCanceler {
    ...
    removeAllPending() {
        pendingMap.forEach((controller) => {
            controller && controller.abort && isFunction(controller.abort) && controller.abort()
        })
        pendingMap.clear()
    }
    /**
